            ...
            for (var i=0;i<eventsCopy.length;i++){
                ...
                for (var h=0;h<horsesCopy.length;h++){
                    if(horsesCopy[h].id_evento_id===eventsCopy[i].id){
                        let hs=horsesCopy[h];
                        if(hs.imagen!==""){
                           hs={...hs,['imagen']:'https://34.69.229.54:8000/'+hs['imagen']} 
                        }
                        ArrayHorses.push(hs);
                    }
                }
                eventsCopy[i]['Horses']=ArrayHorses;
                eventsCopy[i]['imagen']='https://34.69.229.54:8000/'+eventsCopy[i]['imagen'];
                if(eventsCopy[i]['video_procesado']!==""){
                    eventsCopy[i]['video_procesado']='https://34.69.229.54:8000/'+eventsCopy[i]['video_procesado'];
                    eventsCopy[i]['video_original']='https://34.69.229.54:8000/'+eventsCopy[i]['video_original'];
                }
